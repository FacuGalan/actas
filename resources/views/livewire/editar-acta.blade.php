                        ...
                        @else
                            <div class="relative">
                                <label class="flex flex-col items-center justify-center w-full border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-white hover:bg-gray-50 transition-colors duration-200 py-6">
                                    ...
                                    <input type="file" wire:model="foto1" data-comprimir-foto accept="image/jpeg,image/jpg" class="hidden">
                                </label>
                                @if($foto1)
                                    @if($foto1->isPreviewable())
                                        <img src="{{ $foto1->temporaryUrl() }}" alt="Vista previa de la fotografía 1" class="mt-2 w-full max-w-xs rounded-lg border-2 border-gray-300 shadow-sm">
                                    @endif
                                    <div class="mt-2 flex items-center gap-2 text-xs text-emerald-600 bg-emerald-50 p-2 rounded"><svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path></svg><span class="flex-1">Nueva imagen lista para guardar</span><button type="button" wire:click="$set('foto1', null)" class="text-red-600 hover:text-red-800"><svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"></path></svg></button></div>
                                @endif
                                <div data-aviso-compresion wire:ignore class="hidden mt-2 flex items-center gap-2 text-xs text-blue-600 bg-blue-50 p-2 rounded"><svg class="w-4 h-4 animate-spin" fill="none" viewBox="0 0 24 24"><circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle><path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path></svg>Optimizando imagen...</div>
                        ...
                        @else
                            <div class="relative">
                                <label class="flex flex-col items-center justify-center w-full border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-white hover:bg-gray-50 transition-colors duration-200 py-6">
                                    ...
                                    <input type="file" wire:model="foto2" data-comprimir-foto accept="image/jpeg,image/jpg" class="hidden">
                                </label>
                                @if($foto2)
                                    @if($foto2->isPreviewable())
                                        <img src="{{ $foto2->temporaryUrl() }}" alt="Vista previa de la fotografía 2" class="mt-2 w-full max-w-xs rounded-lg border-2 border-gray-300 shadow-sm">
                                    @endif
                                    <div class="mt-2 flex items-center gap-2 text-xs text-emerald-600 bg-emerald-50 p-2 rounded"><svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path></svg><span class="flex-1">Nueva imagen lista para guardar</span><button type="button" wire:click="$set('foto2', null)" class="text-red-600 hover:text-red-800"><svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"></path></svg></button></div>
                                @endif
                                <div data-aviso-compresion wire:ignore class="hidden mt-2 flex items-center gap-2 text-xs text-blue-600 bg-blue-50 p-2 rounded"><svg class="w-4 h-4 animate-spin" fill="none" viewBox="0 0 24 24"><circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle><path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path></svg>Optimizando imagen...</div>
                        ...
                        @else
                            <div class="relative">
                                <label class="flex flex-col items-center justify-center w-full border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-white hover:bg-gray-50 transition-colors duration-200 py-6">
                                    ...
                                    <input type="file" wire:model="foto3" data-comprimir-foto accept="image/jpeg,image/jpg" class="hidden">
                                </label>
                                @if($foto3)
                                    @if($foto3->isPreviewable())
                                        <img src="{{ $foto3->temporaryUrl() }}" alt="Vista previa de la fotografía 3" class="mt-2 w-full max-w-xs rounded-lg border-2 border-gray-300 shadow-sm">
                                    @endif
                        ...
                        @else
                            <div class="relative">
                                <label class="flex flex-col items-center justify-center w-full border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-white hover:bg-gray-50 transition-colors duration-200 py-6">
                                    ...
                                    <input type="file" wire:model="foto4" data-comprimir-foto accept="image/jpeg,image/jpg" class="hidden">
                                </label>
                                @if($foto4)
                                    @if($foto4->isPreviewable())
                                        <img src="{{ $foto4->temporaryUrl() }}" alt="Vista previa de la fotografía 4" class="mt-2 w-full max-w-xs rounded-lg border-2 border-gray-300 shadow-sm">
                                    @endif
                        ...
                        @else
                            <div class="relative">
                                <label class="flex flex-col items-center justify-center w-full border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-white hover:bg-gray-50 transition-colors duration-200 py-6">
                                    ...
                                    <input type="file" wire:model="foto5" data-comprimir-foto accept="image/jpeg,image/jpg" class="hidden">
                                </label>
                                @if($foto5)
                                    @if($foto5->isPreviewable())
                                        <img src="{{ $foto5->temporaryUrl() }}" alt="Vista previa de la fotografía 5" class="mt-2 w-full max-w-xs rounded-lg border-2 border-gray-300 shadow-sm">
                                    @endif
